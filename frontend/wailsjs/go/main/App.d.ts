...
import {repositorygit} from '../models';
...
export function CommitTaskGitRepository(arg1:string,arg2:string,arg3:string):Promise<repositorygit.Repository>;
...
export function ListTaskGitRepositories(arg1:string):Promise<Array<repositorygit.Repository>>;
...
export function PublishTaskGitRepository(arg1:string,arg2:string):Promise<repositorygit.Repository>;
