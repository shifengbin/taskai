...
export namespace gitlab {
	...
	export class Project {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.pathWithNamespace = source["pathWithNamespace"];
...
export namespace main {
	...
	export class GitLabProjectListResult {
	    projects: gitlab.Project[];
	    usesPlainHttp: boolean;

	    static createFrom(source: any = {}) {
	        return new GitLabProjectListResult(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.projects = this.convertValues(source["projects"], gitlab.Project);
	        this.usesPlainHttp = source["usesPlainHttp"];
	    }
...
export namespace storage {
	...
	export class GitLabImportResult {
	    imported: number;
	    skipped: number;
	    infos: task.ExtraInfo[];

	    static createFrom(source: any = {}) {
	        return new GitLabImportResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.infos = this.convertValues(source["infos"], task.ExtraInfo);
	    }
