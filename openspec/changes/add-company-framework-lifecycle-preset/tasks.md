...
- [ ] 7.1 用户确认后，将当前工作区项目对应分支合并进 worktree 分支并解决冲突，再把 worktree 分支合并回当前工作区项目对应分支
- [ ] 7.2 在合并后的当前项目运行完整 Go、前端测试和 `scripts/build-linux.sh`，确认合并结果可编译
- [ ] 7.3 使用 OpenSpec 归档流程同步正式规格与归档文档，检查 `README.md` 和实施记录与最终行为一致
- [ ] 7.4 提交全部相关 Git 变更，确认提交和工作树状态正确后移除已合并 worktree
